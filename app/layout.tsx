  ...
  return (
    <html lang="ko" className="h-full antialiased">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Gowun+Batang:wght@400;700&family=IBM+Plex+Sans+KR:wght@400;500;600;700&family=EB+Garamond:ital,wght@1,500;1,600&family=Mrs+Saint+Delafield&display=swap"
        />
      </head>
